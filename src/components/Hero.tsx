  ...
  return (
    <section className="relative pt-32 pb-24 md:pt-44 md:pb-36 px-6 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        <p className="text-primary font-semibold text-base md:text-lg tracking-wide uppercase mb-6 animate-fade-in-up">
        ...
        {/* Social proof */}
        <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-muted text-sm animate-fade-in-up delay-400">
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
            <span>Crafted with care by AI development specialists</span>
          </div>
          <div className="hidden sm:block w-px h-4 bg-card-border" />
          <span>Patterns we use every day, from projects we actually ship</span>
        </div>
      </div>
    </section>
  );
